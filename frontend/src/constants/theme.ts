...
export const LIGHT = {
  ...
  primaryHover:"#0090CC",
  primaryFg:   "#FFFFFF",
  primaryBg:   "#E6F7FD",   // 연한 파랑 배경
  primaryMuted:"#B3E5F9",   // 더 연한 파랑
...
export const DARK = {
  ...
  primaryHover:"#33BBEF",
  primaryFg:   "#FFFFFF",
  primaryBg:   "rgba(0,169,236,0.12)",
  primaryMuted:"rgba(0,169,236,0.25)",
...
// string으로 매핑해서 LIGHT/DARK 모두 할당 가능하게 함
